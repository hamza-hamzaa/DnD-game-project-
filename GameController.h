...
private:
    ...
    bool reloadVals(std::istream& in, int levelNum, qint64 runElapsed, quint32 levelSeed, int racialPeriod, int movesRacial, int dwarfTurns, int dwarfBonus,
...
public:
    ...
    qint64 victoryTimeMs() const { return victoryElapsedMs; }
